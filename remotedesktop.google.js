...
(function(q, u, c) {
  ...
  function findOn() {
    others = document.querySelectorAll(".list_item .icon_play");
    others.forEach(other => {
      other.parentElement.style.background = '#141414';
    });
  
    on = document.querySelector(".list_item .icon_play.on");
    if (on) {
      on.parentElement.style.background = 'darkslategrey';
    }
  }
  
  setInterval(findOn, 1000);
  
  Mousetrap.bind('ctrl+alt+w', function() {
    document.querySelector('div.nnqbCe').click()
  });